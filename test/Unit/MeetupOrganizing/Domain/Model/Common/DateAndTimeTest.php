...
final class DateAndTimeTest extends TestCase
{
    ...
    {
        $dateAndTime = DateAndTime::fromString('2017-02-01T20:00');
    ...
    public function it_fails_if_the_date_is_not_provided_in_the_right_format(): void
    {
        ...
        $this->expectExceptionMessage('Invalid date/time format. Provided: "2017-01-01 invalid", expected format: "Y-m-d\TH:i"');
